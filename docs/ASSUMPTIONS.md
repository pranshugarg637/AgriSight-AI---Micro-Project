...
| B16 | Shop provider default: OpenStreetMap Overpass (`shop=agrarian`, `shop=garden_centre` with agricultural tags, `shop=farm`), 15 km radius, results cached 24 h in memory, attribution "© OpenStreetMap contributors" shown in the UI. | Brief. |
